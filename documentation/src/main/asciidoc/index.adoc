...
<infinispan
    ...
    xsi:schemaLocation="urn:infinispan:config:15.0 http://www.infinispan.org/schemas/infinispan-config-15.0.xsd
                          urn:infinispan:config:store:redis:15.0 http://www.infinispan.org/schemas/infinispan-cachestore-redis-config-15.0.xsd"
    xmlns="urn:infinispan:config:15.0"
    xmlns:redis="urn:infinispan:config:store:redis:15.0" >

    <cache-container>
        <local-cache>
            <persistence passivation="false">
                <redis-store xmlns="urn:infinispan:config:store:redis:15.0"
